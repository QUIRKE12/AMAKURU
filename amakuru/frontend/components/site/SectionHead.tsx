          ...
          {isSignedIn ? (
            <div className="mt-2 flex items-center gap-2 sm:mt-0">
              <Link
                href="/bookmarks"
                onClick={() => setMenuOpen(false)}
                className="flex items-center gap-2 rounded-full bg-papyrus py-1.5 pl-1.5 pr-3 text-[13px] font-semibold text-ink"
              >
              ...
              <button
                ...
                className="rounded border border-ink px-3 py-1.5 text-[13px] font-semibold text-ink hover:bg-ink hover:text-white"
              >
                Sign out
              </button>
            </div>
